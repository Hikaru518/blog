...
1. 我不应该用 ToolCalling。很多 LLM 应用需要进行 Tool Calling，这是因为上下文不完整。例如一个客服机器人，他得上来先问用户需要什么，这是它并不清楚用户的意图所以无法决策。而作为一个游戏机器人，所有的信息我都已经掌握了，我只需要把当回合内的所有信息都传递给 LLM 就可以了。
